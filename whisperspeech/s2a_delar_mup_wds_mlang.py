...
def make_model(size:str, quantizers:int=4, frozen_embeddings_model:str=None, vq_codes:int=None, frozen_acoustic_embeddings:bool=False, spk_width:int=None, tunables:Tunables=Tunables(), dataset=None):
    ...
    model = _make_model(size, quantizers, tunables,
                        ...
                        stoks_codes=vq_codes, stoks_width=stoks_width)
